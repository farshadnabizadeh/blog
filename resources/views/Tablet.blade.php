    ...
    <div class="relative w-full min-h-screen bg-[#283747]">
        <div id="ClOSEBTN__CONTAINER" class="absolute top-0 left-0 w-full min-h-screen hidden items-center justify-center z-10">
            <div class="w-[98%] h-[900px] border-[1px] bg-[#283747] border-white rounded-md">
                <div class="w-full flex justify-end p-3">
                    <svg id="ClOSEBTN" xmlns="http://www.w3.org/2000/svg" width="50px" height="50px" viewBox="0 0 24 24" fill="none">
                    ...
                    <div class="w-full h-full">
                        <ul class="w-full h-full  overflow-y-scroll">
                            ...
                            <a href="{{ url('/?post='.$Post->id) }}">
                                <li class="w-full py-4 px-16 text-2xl Kanit mt-1 cursor-pointer {{ $id==intval($Post->id)? 'bg-[#2E86C1] text-white' : 'bg-white' }} hover:bg-[#2E86C1] hover:text-white">{{
									$Post->title }}</li>
                            </a>
                            @endif
                            @endforeach
        ...
        <div class="absolute top-0 left-0 w-full min-h-screen z-0">
            <div class="sticky top-0 w-full">
                <div class="w-[50px] h-[50px] p-2 m-5 rounded-full flex justify-center items-center bg-white">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="40px" height="40px" viewBox="0 -0.5 21 21" version="1.1">
